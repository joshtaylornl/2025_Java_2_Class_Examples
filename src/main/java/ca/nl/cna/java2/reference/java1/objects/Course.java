...
public class Course {
    ...
    /**
     * Print this course to a printstream
     * @param printStream printstream like System.io
     */
    public void printStudent(PrintStream printStream){
        printStream.printf("Course info: \n%s\t%s\t\n%s \nCredits: %d",
                this.getNumber(), this.getName(), this.getDescription(), this.getCredits());
    }

    public static void printStudent(Course course, PrintStream printStream){
        printStream.printf("Course info: \n%s\t%s\t\n%s \nCredits: %d",
